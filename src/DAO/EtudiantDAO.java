...
public class EtudiantDAO {
    ...
    public void importSansNote(Etudiant E) {
        Email email = new Email();
        UserDAO userDao = new UserDAO();
        if( userDao.getByLogin(E.getEmail()) ==  null ) {

            User u = new User();

            /* Creating an acount for student. */
            u.setAdmin(false);
            u.setPassword(E.getCne()+ ""+ new Random().nextInt(100));
        ...
        /* Save Student. */
        E.setOneToOne(userDao.getByLogin(E.getEmail()));
        this.save(E);
        ...
        email.setBody("login: " + E.getOneToOne().getLogin() + " Mot de passe: " + E.getOneToOne().getPassword());
